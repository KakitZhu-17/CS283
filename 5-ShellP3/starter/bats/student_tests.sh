...
EOF
    ...
    expected_output="No such file or directorydsh3> dsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="Linuxdsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="cd: No such file or directorydsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output=" arg one arg two arg threedsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="batsdsh3>dsh3>dsh3>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="batsstarterdsh3>dsh3>dsh3>dsh3>dsh3>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="      1       2      12dsh3> dsh3> cmd loop returned 0"
